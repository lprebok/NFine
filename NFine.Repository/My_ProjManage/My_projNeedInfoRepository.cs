...
{
    public class My_projNeedInfoRepository:RepositoryBase<My_ProjNeedInfo>,IMyProjNeedRepository
    {
        public string InsertLog(My_ProjNeedInfo myEntity)
        {
            string strInfo = "";
            myEntity.Create();
            try
        ...
        public string UpdateInfo(My_ProjNeedInfo myEntity)
        {
            string strInfo = "";
